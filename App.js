...
const HeaderComponent = () => {
  return (
    <div className="Header">
      <div className="logo">
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbyAGrJYnYjl-plffyS32C7elDC2CZ15s8yg&s"
          alt="company logo"
        />
      </div>
      <div className="searchBar">
        <form>
          <input
            type="text"
            placeholder="This is Header component"
            vlaue="Header Component"
          ></input>
        </form>
      </div>
